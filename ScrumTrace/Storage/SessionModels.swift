...
enum LocalProcedureBuilder {
    static let version = "local-procedure-2"
    ...
    static func build(
        ...
        let cues = #"(?i)\b(then|next|first|second|third|finally|after that|click|select|open|choose|enter|type|save|press|go to|scroll|submit|return|confirm|verify|result|should|appears|shows|apoi|după aceea|dupa aceea|următorul|urmatorul|mai întâi|mai intai|în final|in final|apasă|apasa|selectează|selecteaza|deschide|alege|introdu|scrie|salvează|salveaza|accesează|acceseaza|trimite|verifică|verifica|ar trebui|apare|afișează|afiseaza|rezultatul)\b"#
