...
enum RecordingAction: String, CaseIterable, Identifiable, Sendable {
    ...
    var needsIdleCapture: Bool {
        switch self {
        case .retryAnalysis, .regenerateLocalExport, .reviewSpeakers, .revealArchive, .revealFolder, .delete:
            return true
...
final class RecordingsModel: ObservableObject {
    ...
    func unavailableReason(_ action: RecordingAction, for entry: SessionEntry) -> String? {
        ...
        case .delete:
            ...
            return nil
        case .revealExport, .copyExportPath, .retryAnalysis, .regenerateLocalExport, .revealArchive, .revealFolder:
            return nil
        }
    }
