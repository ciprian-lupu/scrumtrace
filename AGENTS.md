...
The user additionally requested recognizable Codex project names on 2026-09-15. Desktop handoff prepares a workspace under the recording's codex-workspaces/, named from its exported context, UTC date and recording identifier. It contains copies of export/ only. Reopening refreshes the reference export/ atomically and preserves agent notes elsewhere in the workspace. The prompt asks the agent to give its task a descriptive title. Deleting the recording also deletes these workspaces and notes, as stated in the confirmation. Canonical transfer and reanalysis skip these derived workspaces. All 61 targeted native tests pass (29 handoff/workspace, 25 transfer, 5 snapshots, pack gate and deletion confirmation), and Linux contracts pass. Light/dark Settings layouts were inspected. This is an approved handoff improvement; it does not close hardware gates.
